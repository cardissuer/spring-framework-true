...
public class CarController {
    ...
    @RequestMapping("/info")       //localhost:7070/car/info?make=Honda&year=2015
    ...
    @RequestMapping("/info2")       //localhost:7070/car/info?make=Honda&year=2015
    ...
    @RequestMapping("/info/{make}/{year}")      //localhost:7070/car/info/honda/2015
